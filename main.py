...
from visualize_data import visualize_single, visualize_comparison, visualize_experience_trends
...
if __name__ == '__main__':
    ...
    # Uncomment the next line to plot the data which shows the gains and demand on the market as experience grows
    # visualize_experience_trends([load_data(file) for file in LIST_OF_JAN24_BY_YEARS_OF_EXP])
